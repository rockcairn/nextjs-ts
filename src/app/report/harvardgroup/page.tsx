...
export const metadata: Metadata = {
  title: 'RockCairn.com - Harvard Group',
  keywords: [
    'Harvard Group' ,'Mount Harvard', 'Mount Columbia', 'Sawatch Range',
  ],
};
    ...
    <main className="container content">
      ...
      <article className="climbing-text">
        <section id="summary">
          ...
          <ImageCarousel keywords='harvard columbia'/>
        </section>
        <section id="timeline">
          ...
          <table className="climbing" width="100%">
            <tbody>
              <tr>
                ...
                <td width="80%">
                  -
                  <a className="climbing" href="/report/mountprinceton/2002">
